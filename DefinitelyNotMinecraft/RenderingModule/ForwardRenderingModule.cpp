...
namespace dnm
{
    ...
    ForwardRenderingModule::ForwardRenderingModule(Config* config,
                                                   Renderer* renderer,
    ...
    void ForwardRenderingModule::drawFrame(
        ...
        const vk::raii::Semaphore& previousRenderStepFinished)
    {
        ...
        {
            LightBuffer buffer{
                m_config->lightColor, m_config->ambientStrength,
...

        {
            ...
            m_commandBuffer.reset();
            {
                ...
                m_commandBuffer.drawIndirect(**buffer, 0u, 1u, sizeof(u32) * 4);
            ...
            vk::SubmitInfo graphicsInfo{
                *previousRenderStepFinished,
    ...
    vk::raii::Semaphore& ForwardRenderingModule::getRenderingFinishedSemaphore()
    {
        return m_renderingFinished;
    }

    void ForwardRenderingModule::recreatePipeline()
    {
        m_renderer->waitIdle();
    ...
    void ForwardRenderingModule::recompileShadersIfNecessary(bool force)
    {
        const auto& device = m_renderer->getDevice();
