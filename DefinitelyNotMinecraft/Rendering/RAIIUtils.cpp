...
dnm::gatherLayers(std::vector<std::string> const &layers
#if !defined(NDEBUG)
                  ,
...
dnm::makeCommandBuffer(vk::raii::Device const &device,
...
dnm::makeDescriptorPool(vk::raii::Device const &device,
...
vk::raii::Device
dnm::makeDevice(vk::raii::PhysicalDevice const &physicalDevice,
...
vk::Format
dnm::pickDepthFormat(vk::raii::PhysicalDevice const &physicalDevice) {
...
vk::PresentModeKHR
dnm::pickPresentMode(std::vector<vk::PresentModeKHR> const &presentModes) {
...
vk::SurfaceFormatKHR
dnm::pickSurfaceFormat(std::vector<vk::SurfaceFormatKHR> const &formats) {
