...
BlockDrawCallNode::BlockDrawCallNode(Config *config, Renderer *renderer,
...
bool BlockDrawCallNode::shouldExecute() const { return true; }

IRenderingNode::ExecutionResult
BlockDrawCallNode::execute(const ExecutionData &executionData,
...

  {
    ...
    TracyVkZone(m_computeProfilerContext.context, *commandBuffer,
                "Generate Draw Calls");
    ...
    commandBuffer.bindDescriptorSets(vk::PipelineBindPoint::eCompute,
                                     *m_pipelineLayout, 0u, {*m_descriptorSet},
                                     nullptr);
